...
function ProgramRowImpl({ programs, badge, isLoading }: ProgramRowProps) {
  ...
  return (
    <div className="relative group/row">
      ...
      <button
        onClick={() => scroll("left")}
        className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-2 md:-translate-x-4 z-10 w-10 h-10 rounded-full bg-card border border-border shadow-lg flex items-center justify-center transition-opacity hover:bg-muted md:opacity-0 md:group-hover/row:opacity-100"
      ...
      <button
        ...
        className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-2 md:translate-x-4 z-10 w-10 h-10 rounded-full bg-card border border-border shadow-lg flex items-center justify-center transition-opacity hover:bg-muted md:opacity-0 md:group-hover/row:opacity-100"
