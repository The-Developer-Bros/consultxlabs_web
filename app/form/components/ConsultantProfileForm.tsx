...
const ConsultantProfileForm: React.FC<Props> = ({ onNext, onBack, initialData }) => {

  const { register, handleSubmit, formState: { errors } } = useForm<ConsultantProfile>({
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-md space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Input id="experience" type="number" {...register("experience", { required: true })} />
      ...
      <div className="space-y-2">
        ...
        {errors.subDomains && <p className="text-red-500">{errors.subDomains.message}</p>}
      </div>
