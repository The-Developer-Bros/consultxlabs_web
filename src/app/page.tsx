...
export default function Home() {
  ...
  const [mainBannerImage, setMainBannerImage] = useState<string>("");
  const [servicesImage, setServicesImage] = useState<string>("");
  ...
  useEffect(() => {
    fetchFirebaseImage("frontend/services-image.jpg").then((url) => {
      setServicesImage(url as string);
    });
    fetchFirebaseImage("frontend/main-banner.jpeg").then((url) => {
      setMainBannerImage(url as string);
    });
  }, []);
  ...
  return (
    <ReduxProvider store={store}>
          ...
          <div className="flex flex-col justify-around space-y-4">
            <div className="space-y-2">
              ...
              <p className="w-2/3 text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                We provide a range of services including 1-1 sessions, classes,
                webinars, and conferences. Our experts are ready to share their
      ...
      <section className="container mx-auto px-4 grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mb-10">
        <Card className="rounded-lg shadow-md">
          ...
          <CardContent className="text-gray-900 dark:text-gray-900">
            Connect with experts for personal sessions and gain insights from
            industry leaders.
          </CardContent>
        </Card>
        <Card className="rounded-lg shadow-md">
          ...
          <CardContent className="text-gray-900 dark:text-gray-900">
            Join classes offered by professionals and broaden your knowledge in
            various fields.
          </CardContent>
        </Card>
        <Card className="rounded-lg shadow-md">
