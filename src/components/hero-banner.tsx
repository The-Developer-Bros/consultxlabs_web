 ...
 * @see https://v0.dev/t/CDWravTtYK2
 */
  ...
  return (
    <main className="flex-1">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32">
        <div className="container grid items-center gap-6 lg:gap-12 xl:grid-cols-[1fr_550px] px-4 md:px-6">
          <Image
            alt="Image"
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
        <div className="container px-4 md:px-6">
          <div className="grid items-center justify-center gap-4">
            ...
            <div className="grid w-full grid-cols-2 lg:grid-cols-4 items-center justify-center gap-8 lg:gap-12">
              <Card>
                <CardHeader>
                  <Avatar />
