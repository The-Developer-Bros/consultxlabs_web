          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div className="grid gap-0.5 text-xs">
                ...
                <div className="text-gray-500 dark:text-gray-400">Posted on December 12, 2023</div>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            ...
            <p className="mt-2 text-gray-500">
              Consultancy has always been about helping businesses make better decisions...
            </p>
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div className="grid gap-0.5 text-xs">
                ...
                <div className="text-gray-500 dark:text-gray-400">Posted on December 15, 2023</div>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            ...
            <p className="mt-2 text-gray-500">
              As AI continues to evolve, what does this mean for the consultancy industry...
            </p>
            <div className="flex items-center mt-4 space-x-2">
